...
from data_pipeline.feature_extraction.core.mask_geometry import extract_geometry_metrics_batch
...
def main() -> None:
    ...
    feature_df = extract_geometry_metrics_batch(merged, pixel_size_col="micrometers_per_pixel")
