...
from data_pipeline.feature_extraction.core.curvature_metrics import extract_curvature_metrics_batch
...
def main() -> None:
    ...
    feature_df = extract_curvature_metrics_batch(merged, pixel_size_col="micrometers_per_pixel")
