...
from src.legacy.vae import BaseConfig
...
class AutoConfig(BaseConfig):
    ...
    def from_json_file(cls, json_path):
        ...
        if config_name == "BaseAEConfig":
            ...
            from src.legacy.vae import MetricVAEConfig
            ...
            from src.legacy.vae import MorphIAFVAEConfig
