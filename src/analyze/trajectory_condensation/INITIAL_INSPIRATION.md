# Initial Inspiration: Trajectory Cosmology

This note preserves the original conceptual motivation for trajectory
condensation in `morphseq`.

Status:
- historical and conceptual
- worth keeping as inspiration
- not a normative implementation spec

Current implementation lives in this package:
- [README.md](README.md)
- [ALGORITHM.md](ALGORITHM.md)
- [DESIGN.md](DESIGN.md)
- [viz/README_viz.md](viz/README_viz.md)

The key reason to keep this note is that it captures the "why" of the method:
development is a set of trajectories, not snapshots, and useful structure
should emerge from persistent co-travel over time rather than instantaneous
similarity alone.
