...
from src.legacy.vae.models.vae.vae_config import VAEConfig
import pandas as pd
from src.legacy.vae.auxiliary_scripts.make_training_key import make_seq_key, make_train_test_split
import numpy as np

@dataclass
class MorphIAFVAEConfig(VAEConfig):
    """
