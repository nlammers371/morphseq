...
class AutoModel(nn.Module):
    ...
    def load_from_folder(cls, dir_path: str):
        ...
        if model_name == "Adversarial_AE_Config":
            ...
            from src.vae.models._Archive.metric_vae import MetricVAE
            ...
            from src.vae.models._Archive.morph_iaf_vae import MorphIAFVAE
