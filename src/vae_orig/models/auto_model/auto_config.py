...
class AutoConfig(BaseConfig):
    ...
    def from_json_file(cls, json_path):
        ...
        if config_name == "BaseAEConfig":
            ...
            from src.vae.models._Archive.metric_vae import MetricVAEConfig
            ...
            from src.vae.models._Archive.morph_iaf_vae import MorphIAFVAEConfig
