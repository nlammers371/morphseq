...
image_dir = "/Users/nick/Dropbox (Cole Trapnell's Lab)/Nick/morphMap/data/yx1_samples/segmentation/testing_images_np_ds/"
...
args = app.parse_args([])
args.headless = True
args.project = "/Users/nick/Dropbox (Cole Trapnell's Lab)/Nick/morphMap/data/yx1_samples/segmentation/training_images_ds/kikume_model_v1.ilp"  # REPLACE WITH YOUR PROJECT FILE
...
# input_data1 = vigra.taggedView(input_data1, "zyx")
# input_data2 = vigra.taggedView(input_data2, "zyx")
