from src.build.build02B_segment_bf_main_v2 import apply_unet
...
n_class_vec = [1, 1, 1]
model_name_vec = ["mask_v0_0050", "bubble_v0_0050", "focus_v0_0050"] #, "via_v0_0050"] #, "unet_yolk_v1_0050", "unet_focus_v2_0050"]
segment_list = None
