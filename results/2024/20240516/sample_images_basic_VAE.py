from src.vae.auxiliary_scripts.generate_sample_images import generate_sample_images
...
for architecture_name in architecture_name_vec:
    generate_sample_images(root, train_name, architecture_name, n_image_figures=n_image_figures,
