...
def main():
    ...
    #####################
    train_suffix_vec = ["gdf3_lmx", "all",  "shh_lmx"]
    temperature_vec = [22] # , 50]
    ...
    metric_key_path = "/media/nick/hdd02/Cole Trapnell's Lab Dropbox/Nick Lammers/Nick/morphseq/metadata/curation/perturbation_metric_key_20240511.csv"
    pert_time_key_path_vec = ["/media/nick/hdd02/Cole Trapnell's Lab Dropbox/Nick Lammers/Nick/morphseq/metadata/curation/perturbation_train_key_gdf3_30_no_lmx1b.csv", "",
                              "/media/nick/hdd02/Cole Trapnell's Lab Dropbox/Nick Lammers/Nick/morphseq/metadata/curation/perturbation_train_key_no_shh_no_lmx1b.csv"]
    ...
    for t, train_suffix in enumerate(train_suffix_vec):
        for temperature in temperature_vec:
            ...
            train_suffix_in = train_suffix + f"_temp{temperature:02}"
            output_dir = train_vae(root, train_folder, train_suffix=train_suffix_in, model_type=model_type,
                                ...
                                learning_rate=learning_rate, n_conv_layers=n_conv_layers, self_target_prob=self_target_prob, test_dates=test_dates,
