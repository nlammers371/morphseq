from src.legacy.vae import calculate_latent_info_stats
...
architecture_name_vec = ["SeqVAE_z100_ne250_triplet_loss_test_self_and_other", "SeqVAE_z100_ne250_gamma_temp_self_and_other", "SeqVAE_z100_ne250_gamma_temp_SELF_ONLY"]
