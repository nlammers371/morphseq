...
def main():
    ...
    #####################
    train_suffix = "triplet_loss_test"
    temperature = 15 # , 50]
    ...
    pert_time_key_path = "/media/nick/hdd02/Cole Trapnell's Lab Dropbox/Nick Lammers/Nick/morphseq/metadata/curation/perturbation_train_key_gdf3_30_no_lmx1b.csv"
