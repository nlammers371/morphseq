...
model_name_vec = ["mask_raw_v1_0100"]#, "bubble_raw_v0_0050", "focus_raw_v0_0050"]#'["mask_v0_0050", "bubble_v0_0050", "focus_v0_0050"] #, "via_v0_0050"] #, "unet_yolk_v1_0050", "unet_focus_v2_0050"]
...
for m, model_name in enumerate(model_name_vec):
    apply_unet(root=root, model_name=model_name,  n_classes=1, checkpoint_path=checkpoint_path,
               n_workers=n_workers, overwrite_flag=overwrite, make_sample_figures=True, n_sample_figures=5000)