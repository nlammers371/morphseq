...
if __name__ == "__main__":
    ...
    #####################
    # Optional arguments
    train_suffix = "test"# "triplet_loss_test"
    temperature_vec = [1, 5, 10]
    gamma_vec = [100, 1, 10, 1000] #[0.0001, 0.001, 0.01, 0.1, 1]
    batch_size = 64
    n_epochs = 250
    beta = 1 #[0.01, 0.1, 1]
    latent_dim = 100
    ...
    for gamma in gamma_vec:
        for temperature in temperature_vec:
            output_dir = train_vae(root, train_folder, train_suffix=train_suffix, model_type=model_type,
                                latent_dim=latent_dim, batch_size=batch_size, beta=beta, n_load_workers=4, metric_loss="triplet"
