...
def main():
    ...
    # stitch FF images
    stitch_ff_from_keyence(data_root, n_workers=n_workers, par_flag=par_flag, overwrite_flag=overwrite_flag, orientation_list=orientation_list, dir_list=dir_list)
