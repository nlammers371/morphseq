...
if __name__ == "__main__":
    ...
    # This is a second attempt following corrections to a bug that compromised sequential pair selection
    ...
    #####################
    # Optional arguments
    train_suffix = "temperature_sweep_v3"
    temperature_vec = [0.0001, 0.001, 0.01, 0.1]
    batch_size = 64
    n_epochs = 250
