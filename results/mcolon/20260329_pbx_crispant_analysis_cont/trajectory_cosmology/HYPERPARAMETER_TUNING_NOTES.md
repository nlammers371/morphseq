...
**File**: `results/mcolon/20260329_pbx_crispant_analysis_cont/results/bifurcating_trunk_v4/force_sweeps.png`
...
Families: repulsion_strength_mult | fidelity_init_strength | fidelity_half_life_iters
          epsilon_void             | stretch_strength_mult  | bend_strength_mult

Generated by `bifurcating_trunk_sandbox.py --fidelity-half-life-sweep` (n=40/branch, 300 iter).
