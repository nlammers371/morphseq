#!/usr/bin/env python3
"""
WT Full Time Matrix: Predict All Timepoint Pairs

Trains Ridge models for ALL valid (start_time → target_time) pairs across
the full developmental timeline (10-120 hpf), not just from a single start time.
...
This reveals:
- Which developmental stages are most/least predictable
...
# Genotypes
TRAIN_GENOTYPE = 'cep290_wildtype'
...
OUTPUT_DATA_DIR = DATA_DIR / 'wt_full_time_matrix'
OUTPUT_PLOT_DIR = PLOT_DIR / 'wt_full_time_matrix'
...
def create_full_time_matrix_heatmaps(
    ...
    plt.suptitle('Full Time Matrix: WT Ridge Model Predictions', fontsize=16, fontweight='bold', y=0.995)
    plt.tight_layout()
