#!/usr/bin/env python3
"""
Heterozygous Full Time Matrix: Predict All Timepoint Pairs

Trains Ridge models on HETEROZYGOUS embryos for ALL valid (start_time → target_time)
...
This reveals:
- Which developmental stages are most/least predictable in Het trajectory
...
# Genotypes
TRAIN_GENOTYPE = 'cep290_heterozygous'
...
OUTPUT_DATA_DIR = DATA_DIR / 'het_full_time_matrix'
OUTPUT_PLOT_DIR = PLOT_DIR / 'het_full_time_matrix'
...
def create_full_time_matrix_heatmaps(
    ...
    plt.suptitle('Full Time Matrix: Het Ridge Model Predictions', fontsize=16, fontweight='bold', y=0.995)
    plt.tight_layout()
