...
Outputs (saved to preprocessing_param_sweep/):
- preprocessing_comparison_20251017_combined_A02_e01_t0064.png
- preprocessing_comparison_20250512_E06_e01_t0086.png
...
def main():
    ...
    embryos = [
        "20251017_combined_A02_e01_t0064",  # A02 embryo for testing
    ...
    # Output directory (results/mcolon/20251028/preprocessing_param_sweep/)
