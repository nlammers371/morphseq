...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run inj_ctrl vs pbx1b_pbx4_crispant classification per experiment and combined in the 20260407 PBX analysis folder."
    )
    ...
    parser.add_argument(
        "--results-subdir",
        default="injctrl_vs_double_bin2_perm500",
...
def main() -> None:
    ...
    manifest_payload = {
        "analysis": "pairwise_injctrl_vs_double_by_experiment",
        "pair": [GROUP1, GROUP2],
