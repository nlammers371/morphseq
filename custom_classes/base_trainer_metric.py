# NL: This is adapted from the base_trainter script in the pythae repo:
# https://github.com/clementchadebec/benchmark_VAE/blob/main/src/pythae/trainers/base_trainer/base_trainer.py
import contextlib
import datetime
import logging
import os
...
from pythae.data.datasets import BaseDataset, DatasetOutput#, collate_dataset_output
